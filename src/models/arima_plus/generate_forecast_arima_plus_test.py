...
"""Tests for generate_forecast_arima_plus."""
...
from models.arima_plus import generate_forecast_arima_plus
from google3.testing.pybase import googletest


class GenerateForecastArimaPlusTest(googletest.TestCase):
  ...
  def test_build_generate_arima_plus_query_success(self):
    query = generate_forecast_arima_plus.build_generate_arima_plus_query(
        "proj",
        "dataset",
        "table",
        "model_name",
    ...
    self.assertIn("proj.dataset.model_name", query)
  ...
  def test_generate_final_arima_plus_sequence_success(
    ...
    generate_forecast_arima_plus.generate_final_arima_plus_sequence(
        "params.yaml"
    )
  ...
  @mock.patch.object(utils, "upload_to_gcs", autospec=True)
  def test_generate_final_arima_plus_missing_params(self, mock_upload):
